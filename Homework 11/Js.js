...
addBtn.onclick = () => {
    if (nameBox.value != "" &&
        ...
        addItem(dataBox.value, "third-column");
...
clearBtn.onclick = () => {
    list.innerHTML =
        "<div class=\"first-column\">Марка машини</div>\n" +
        "<div class=\"second-column\">Ціна</div>\n" +
        "<div class=\"third-column\">Дата випуску</div>\n" +
        "<div class=\"fourth-column\">Кількість Місць</div>"
}